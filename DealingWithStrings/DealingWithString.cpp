...
int main()
{
    ...
    string S1 = "My Name is Youssef -Bounite, I Love Programming.";
    ...
    // Returns the letter st position 3
    ...
    // Adds one character to the enf of the string 
